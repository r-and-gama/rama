...
[![Travis build status](https://travis-ci.org/r-and-gama/rama.svg?branch=master)](https://travis-ci.org/r-and-gama/rama)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/r-and-gama/rama?branch=master&svg=true)](https://ci.appveyor.com/project/r-and-gama/rama)
...
`rama` to the design and exploitation of experiments' simulations as outlined
above.
...
The package `rama` contains one unique class, `experiment` that contains all
...
linking `rama` to a GAMA engine on the system. If GAMA is not installed on the
...
and follow instructions. Otherwise, you can input your local path to the application Gama Platform, in this case the function will not be interactive and will configure GAMA path for `rama`:
...
`rama` is developed under the umbrella of the IRD- and OUCRU-funded EID JEAI by:
