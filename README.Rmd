...
and follow instructions. Otherwise, you can input your local path to install the application Gama Platform, in this case the function will not be interactive:
