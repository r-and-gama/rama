...
set_environment_variables <- function() {
  ...
  options(rama.workspace                     = rama_workspace,
          ...
          rama.default.gama.win64            = "/gama_1_8_final_win64.tgz",
          rama.default.gama.win32            = "/gama_1_8_final_win64.tgz",
          rama.default.gama.win.appdir       = "C:/Program Files/gama",
          rama.default.gama.win.zip.appdir   = "gama",
          rama.default.gama.osx              = "/gama_1_8_final_osx.tgz",
          ...
          rama.default.gama.linux.appdir     = "/usr/share/gama",
