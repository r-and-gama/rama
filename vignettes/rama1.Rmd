...
For example, we add the simulations by:

```{r}
simulation_num <- 5
my_experiment1 <- do.call(rbind, lapply(1:simulation_num, function(x) exp1))
my_experiment1$p_beta <- runif(simulation_num, min = 0, max = 1)
...
## 3.2 Seeing the model path and experiment name
